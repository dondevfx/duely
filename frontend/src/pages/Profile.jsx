            ...
            <div className="relative">
              <button
                ...
                style={{
                  ...
                  border: `2px solid ${profile.profile_color || '#1E90FF'}`,
                  color: profile.profile_color || '#1E90FF',
                  boxShadow: `0 0 18px ${profile.profile_color || '#1E90FF'}66`,
                }}>
                    ...
                    <div className="grid grid-cols-6 gap-2">
                      {COLORS.map(c => (
                        <button
                          ...
                          style={{
                            backgroundColor: c,
                            borderColor: (profile.profile_color || '#1E90FF') === c ? '#fff' : 'transparent',
                            boxShadow: (profile.profile_color || '#1E90FF') === c ? `0 0 8px ${c}` : 'none',
                          }}
                        />
                      ))}
                    </div>
