        ...
        <div className="p-6">
          ...
          <div className="mb-5">
            <button
              ...
              className="w-full flex items-center justify-between text-sm font-bold text-white py-1"
            >
            ...
            return (
              <div key={f.id} className="flex items-center gap-2 mb-2 last:mb-0">
                <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-black shrink-0"
                  style={{ backgroundColor: `${p?.profile_color || '#1568D8'}22`, border: `1.5px solid ${p?.profile_color || '#1568D8'}`, color: p?.profile_color || '#1568D8' }}>
...
export default function Profile() {
  ...
  const COLORS = [
    '#1568D8','#00BFFF','#22c55e','#ef4444','#f97316',
            ...
            <div className="relative">
              <button
                ...
                style={{
                  ...
                  border: `2px solid ${profile.profile_color || '#1568D8'}`,
                  color: profile.profile_color || '#1568D8',
                  boxShadow: `0 0 18px ${profile.profile_color || '#1568D8'}66`,
                }}>
                    ...
                    <div className="grid grid-cols-6 gap-2">
                      {COLORS.map(c => (
                        <button
                          ...
                          style={{
                            backgroundColor: c,
                            borderColor: (profile.profile_color || '#1568D8') === c ? '#fff' : 'transparent',
                            boxShadow: (profile.profile_color || '#1568D8') === c ? `0 0 8px ${c}` : 'none',
                          }}
                        />
                      ))}
                    </div>
