    ...
    <>
      <style>{`
        @keyframes cf-coin-glow {
          0%,100% { filter: drop-shadow(0 0 16px rgba(24,119,242,0.65)) drop-shadow(0 10px 30px rgba(0,0,0,0.8)); }
          50%      { filter: drop-shadow(0 0 34px rgba(24,119,242,1.0))  drop-shadow(0 12px 38px rgba(0,0,0,0.9)); }
        }
      `}</style>
      ...
      <div style={{
        ...
        >
          ...
          <div style={{
            ...faceBase,
            background: 'radial-gradient(circle at 38% 32%, #a0d8ff 0%, #1877F2 42%, #0050bb 72%, #003088 100%)',
          ...
          <div style={{
            ...
            <span style={{
              fontSize: 66, fontWeight: 900, color: '#1877F2', lineHeight: 1,
          ...
          <div className="mb-6 text-center">
            ...
            {resultLanded && flipResult && (
              <div
                ...
                style={{ textShadow: '0 0 20px rgba(24,119,242,0.9)', animation: 'none' }}
              >
