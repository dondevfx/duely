...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        glow:         '0 0 20px rgba(30,144,255,0.45)',
        'glow-lg':    '0 0 40px rgba(30,144,255,0.65)',
      ...
      keyframes: {
        pulseGlow: {
          '0%,100%': { boxShadow: '0 0 20px rgba(30,144,255,0.45)' },
          '50%':     { boxShadow: '0 0 40px rgba(30,144,255,0.9)' },
        },
